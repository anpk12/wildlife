...
<?php if ($this->views->hasContent('featured-1',
                                   'featured-2',
                                   'featured-3')) : ?>
...
<?php if ( $this->views->hasContent('triptych-1',
                                    'triptych-2',
                                    'triptych-3') ) : ?>
...
<?php if ($this->views->hasContent('footercol-1',
                                   'footercol-2',
                                   'footercol-3',
                                   'footercol-4')) : ?>
<div id='wrap-footercol'>
    <div id='footercol-1'><?php $this->views->render('footercol-1')?></div>
    <div id='footercol-2'><?php $this->views->render('footercol-2')?></div>
    <div id='footercol-3'><?php $this->views->render('footercol-3')?></div>
    <div id='footercol-4'><?php $this->views->render('footercol-4')?></div>
</div>
<?php endif; ?>
